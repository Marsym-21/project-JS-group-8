...
function checkValue(value) {
  ...
  } else {let message = "No more information about this book"
  return message;
}
}

 export function renderBookInformation() {
  ...
  booksInform
   ...
   >
       ...
       <button type="button" class="modal-book__button" id="${data.id}">${checkMessage()}</button>  
   </div>  
        `;
...
function closeBtn() {
  ...
  export function renderModalWindow(e) {
    booksInform = new getBookData(id = e.currentTarget.id); 
